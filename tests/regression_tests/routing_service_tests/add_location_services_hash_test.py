...
class TestAddLocationServicesHash:
    ...
    def test_add_location_services_hash_method_works(self, api_client):
        allure.step("Verify that response is not empty and status code is 200")
        _response = api_client.routing_svc.add_location_services_hash(self.hash_)
