...
class TestGetTasksById(object):
    ...
    def test_get_tasks_by_id_method_works(self):
        response_ = ApiClient().log_fetch_svc.get_tasks_by_id()
    ...
    def test_attributes_in_get_tasks_by_id_method(self):
        response_ = ApiClient().log_fetch_svc.get_tasks_by_id()[0]
