        ...
        for endpoint in endpoints:
            ...
            for port in port_range:
                ...
                try:
                    ...
                    if response_:
                        logger.logger.info(F"The port {port} for endpoint {endpoint['name']} is available for connect!")
                    else:
                        logger.logger.error(F"The port {port} for endpoint {endpoint['name']} is not available!")
